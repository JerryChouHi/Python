...
F28_bin_definition = [('PCLK_O/S', 5, 5),
                      ('HSYNC_O/S', 5, 5),
                      ('VSYNC_O/S', 5, 5),
                      ('D9_O/S', 5, 5),
                      ('D8_O/S', 5, 5),
...
JX828_bin_definition = [('VSYNC_O/S', 5, 5),
                        ('HSYNC_O/S', 5, 5),
                        ('PCLK_O/S', 5, 5),
                        ('EXCLK_O/S', 5, 5),
                        ('RSTB_O/S', 5, 5),
...
def main():
    ...
    # 项目 1:F28_bin_definition,2:JX828_bin_definition
    if argv.count('-p') != 0:
        project_id = argv[argv.index('-p') + 1]
        if project_id == '1':
            bin_definition = F28_bin_definition
        elif project_id == '2':
            bin_definition = JX828_bin_definition
    else:
        bin_definition = F28_bin_definition  # 默认F28项目
    ...
    for file in file_list:
        print(file)
        # parse file
        error_message = parse_file(file, bin_definition)
        # save data
