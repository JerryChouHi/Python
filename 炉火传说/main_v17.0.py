...
class Hero(Card):
    def __init__(self, hero):
        ...
        if self.hero_class == 'shaman':
            stone_totem = Card('石爪图腾', 'totem', '', 0, 2, 1)
                ...
                if i == 0 and self.myhero.damage > 0:
                    ...
                    if len(opposite) == 1:
                        ...
                        if not self.enemyworldcards[choose_num - 2].alive:
                            if self.enemyworldcards[choose_num - 2].race == 'totem':
                                self.enemyworldcards[choose_num - 2].remain_health = self.enemyworldcards[
                                    choose_num - 2].health
                                self.enemyworldcards[choose_num - 2].alive = True
                                self.enemyworldcards[choose_num - 2].sleep = True
                                self.enemyhero.totem.append(self.enemyworldcards[choose_num - 2])
